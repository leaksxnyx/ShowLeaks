...
const SupportModal: React.FC<SupportModalProps> = ({ isOpen, onClose }) => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Due to the nature of digital content, we generally don\'t offer refunds. However, if you experience technical issues, please contact our support team and we\'ll work to resolve them.'
    },
    {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-gradient-to-br from-dark-200 to-dark-100 w-full max-w-4xl rounded-2xl shadow-2xl border border-dark-100/50 animate-fade-in-up max-h-[90vh] overflow-hidden">
          {/* Header */}
